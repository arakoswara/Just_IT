    ...
    public List<List<HashMap<String,String>>> parse(JSONObject jObject){
        ...
        try {
            ...
            for(int i=0;i<jRoutes.length();i++){
                ...
                {
                    String travel_time = (String)((JSONObject)((JSONObject)jLegs.get(j)).get("distance")).get("text");
                    String duration = (String)((JSONObject)((JSONObject)jLegs.get(j)).get("duration")).get("text");

                    Log.d("TRAVEL TIME", travel_time);
                    ...
                    for(int k=0;k<jSteps.length();k++)
                    {
                        ...
                        for(int l=0;l<list.size();l++)
                        {
                            ...
                            hm.put("travel_time", travel_time);
